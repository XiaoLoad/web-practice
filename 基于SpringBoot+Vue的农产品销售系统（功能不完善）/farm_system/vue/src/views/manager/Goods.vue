  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="生产厂商" prop="manufacturer"></el-table-column>
        ...
        <el-table-column label="保质期（月）" prop="shelfLife"></el-table-column>
    ...
    <el-dialog title="养殖饲料信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" ref="formRef" :rules="rules" style="padding-right: 50px">
        ...
        <el-form-item label="生产厂家" prop="manufacturer">
          <el-input v-model="data.form.manufacturer" autocomplete="off" />
        </el-form-item>
        <el-form-item label="生产日期" prop="productionDate">
          <!-- <el-input v-model="data.form.productionDate" autocomplete="off" /> -->
          <el-date-picker v-model="data.form.productionDate" value-format="YYYY-MM-DD" format="YYYY/MM/DD"
            type="datetime" placeholder="Select date and time" :default-time="defaultTime"
            :disabled-date="pickerOptions" />
        </el-form-item>
        <el-form-item label="保质期" prop="shelfLife">
          <el-input v-model="data.form.shelfLife" autocomplete="off" />
        </el-form-item>
...
const handleImgSuccess = (res) => {
  data.form.img = res.data.img_url; // res.data就是文件上传返回的文件路径，获取到路径后赋值表单的属性
};
