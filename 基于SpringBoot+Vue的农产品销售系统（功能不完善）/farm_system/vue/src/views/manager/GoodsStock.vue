<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.goodsName" style="width: 300px; margin-right: 10px" placeholder="请输入养殖饲料名称查询"></el-input>
    ...
    <el-dialog title="进货信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        <el-form-item label="养殖饲料" prop="goodsId">
          <el-select v-model="data.form.goodsId" placeholder="请选择养殖饲料" style="width: 100%">
            <el-option
        ...
        <el-form-item label="进货批次">
          <el-input v-model="data.form.batchId" placeholder="请输入批次"></el-input>
        </el-form-item>
